...
impl NoProtoPointer {
    ...
    pub fn new(offset: u32, bytes: Vec<u8>, model: JsonValue) -> Self {
        ...
        NoProtoPointer {
            offset: offset,
            address: u32::from_le_bytes(head), // address of value
            value: NoProtoPointer::str_type_to_enum(this_type),
    ...
    pub fn set_string(&mut self, value: &str) -> std::result::Result<bool, &'static str> {
        ...
        match type_str {
            "string" => {
                ...
                for x in 0..4 {
                    self.bytes[(self.offset + x) as usize] = addr_bytes[x as usize];
                }
